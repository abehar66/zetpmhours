					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Reporte Talleres",
									"targetURL": "#zetpmhours-display"
								}
							}]
						}]
					}
						...
						"inbounds": {
							"zetpmhours-display": {
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=zetpmhours",
									"url": sap.ui.require.toUrl("zetpmhours")
								}
							}
						}
					}
